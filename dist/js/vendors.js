...
/******/ 	var hotCurrentHash = "582b3b4261595f6e6b94"; // eslint-disable-line no-unused-vars
...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "js/" + chunkId + ".chunk.js?" + {"0":"1e328aca73a98f094202","1":"68a5d607e265ec0b0b73","2":"c32ada75cf6b53cbd3d9","3":"38d33007b84b8dce263f","4":"049acb10d8e859c4671a","5":"611fa1e1b6cc8914bf75","6":"658d815aa23fd5074eec","7":"c8b37e34708bdf747644","8":"baa4432552225133e75e","9":"7b571793da96752a6fbf","10":"1d595a90bc435680cdfd","11":"fd50bb0eb811a507df1a","12":"db7f7481dcdda888a13c"}[chunkId] + "";
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(5), __webpack_require__(0), __webpack_require__(4)))
...
var api = '/weixin/learning/make_appointment/free_course';
var url = './exp-result.html';
...
for (var _i = 0; _i < times.length; _i++) {
    //append date
    var value = times[_i].year + '-' + times[_i].month + '-' + times[_i].day;
    var cDate = times[_i].month + '月' + times[_i].day + '日';
    var html = '<div class="line-four"><input type="radio" name="date" value="' + value + '" id="' + value + '"><label class="default" for="' + value + '"><p>' + times[_i].week + '</p><p>' + cDate + '</p></label></div>';
...
var setTime = function setTime(val) {
    //vcode count
    if (isCounting) {
...
var api = '/weixin/learning/make_appointment/normal_course';
var url = './fom-result.html';
...
$('#confirm').click(function () {
    var classType = void 0,
        ...
        images = void 0,
        description = void 0;
    if (!checked.classType) return weui.alert('请选择课程类型');
    if (!checked.date) return weui.alert('请选择日期');
    if (!checked.time) return weui.alert('请选择时间');
    classType = checked.classType[0].value;
    date = checked.date[0].value;
    time = checked.time[0].value;
    images = imgs.imgs;
    description = $('#description')[0].value;
...
var rate = __webpack_require__(24);
